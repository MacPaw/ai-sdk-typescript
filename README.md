...
Used by `createAIGatewayProvider`, `createGatewayProvider`, `createGatewayFetch`, `createVideoClient`, `createCreditBalanceClient`, and Nest `AIGatewayModule`.
