...
- Use `@macpaw/ai-sdk` for `createAIGatewayProvider`, `createGatewayProvider`, `createGatewayFetch`, `createVideoClient`, `createCreditBalanceClient`, `GATEWAY_PROVIDERS`, errors, and `GatewayProviderSettings`.
