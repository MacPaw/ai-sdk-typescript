...
- Use `@macpaw/ai-sdk` for `createAIGatewayProvider`, `createGatewayProvider`, `createGatewayFetch`, `createVideoClient`, `createCreditBalanceClient`, errors, and `GatewayProviderSettings`.
