...
- Use `@macpaw/ai-sdk` for `createAIGatewayProvider`, `createGatewayProvider`, `createGatewayFetch`, `createVideoClient`, `createVoiceClient`, `createCreditBalanceClient`, errors, and `GatewayProviderSettings`.
